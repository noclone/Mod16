...
public class TileEntityClearer extends LockableTileEntity implements ISidedInventory, ITickableTileEntity{
    ...
    public TileEntityClearer() {
        super(ModTileEntities.CLEARER_TILE_ENTITY.get());
    ...
    protected ITextComponent getDefaultName() {
        return new TranslationTextComponent("Card Clearer");
    }


    @Override
    protected Container createMenu(int id, PlayerInventory playerInventory) {
        return new ContainerClearer(id, playerInventory, this, this.fields);
    }
