...
public class PaymentTerminal extends Block {
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new TileEntityPaymentTerminal();
    }
    ...
    public void interactWith(World world, BlockPos pos, PlayerEntity player) {
        ...
        if (tileEntity instanceof TileEntityPaymentTerminal && player instanceof ServerPlayerEntity) {
